...
## PLEASE NOTE: 
The original function of this competition will not be changed under any circumstances. We may only beautify it and add more information should we feel it is a necessary thing to do. Hopefully people will not cheat and we will not be forced to alter any of the rules. Therefore ButtCoin takes all rights to make any necessary changes should there be a necessity to avoid the cheating.
